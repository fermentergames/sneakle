...
USE_RANDOM_FILL = True # instead of each row being a word, just fill empty tiles with the LETTER_SET_DEFAULT
FORCED_SECRET_WORD = "" # None # set to a string like "REMINDER" to force a specific secret word
